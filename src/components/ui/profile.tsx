...
export default function GitHubProfileViewer() {
  ...
  return (
    <div 
      ...
      style={{ 
        backgroundImage: "url('/img1.jpg')", // Use the correct path
        backgroundSize: "cover", 
        backgroundPosition: "center"
      }}
    >
      <Card className="w-full max-w-2xl p-6 space-y-4 shadow-lg rounded-lg bg-gradient-to-r from-blue-200 to-purple-200">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600">
            ...
            repositories, search like: AreebaSadiq23
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-md hover:from-green-500 hover:to-blue-600 transition duration-200 ease-in-out"
            >
